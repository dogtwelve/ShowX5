...
var FamousScroller = _interopRequire(require("famous/views/Scroller"));
...
var Scroller = (function (_FamousComponent) {
  function Scroller() {
  ...
  _inherits(Scroller, _FamousComponent);
  ...
  _createClass(Scroller, {
    ...
    famousCreateNode: {
      value: function famousCreateNode(parentNode) {
        var scroller = this.getFamous();
        var node = parentNode.add(scroller);
        var next = [];
