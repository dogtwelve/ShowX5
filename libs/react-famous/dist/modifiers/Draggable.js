...
var FamousDraggable = _interopRequire(require("famous/modifiers/Draggable"));
...
var Draggable = (function (_FamousComponent) {
  function Draggable() {
  ...
  _inherits(Draggable, _FamousComponent);
  ...
  _createClass(Draggable, {
    ...
    famousCreateNode: {
      value: function famousCreateNode(parentNode) {
        var draggable = this.getFamous();
        var node = parentNode.add(draggable);
